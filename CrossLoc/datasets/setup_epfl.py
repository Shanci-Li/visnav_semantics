...
def main(args):
    ...
    for mode in ['lhs_sim', 'drone_sim', 'drone_real', 'oop_drone_sim', 'oop_drone_real']:
        ...
        split_data(os.path.join(dst_dir, mode), mode, 'epfl', args.ignore_3d_label)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Setup VNAV EPFL dataset.',
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    parser.add_argument('--dataset_dir', type=str, required=True,
                        help='Dataset storing the structured datasets.')

    parser.add_argument('--lhs_dir', type=str, default='EPFL-LHS',
