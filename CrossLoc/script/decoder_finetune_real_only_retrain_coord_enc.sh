...
ENC_FT_COORD=$PROJ_DIR/weights/encoders-special/${DATASET}/real-only/coord/model-rc${PT_REAL_DATA_CHUNK}.net
ENC_FT_DEPTH=$PROJ_DIR/weights/encoders-special/${DATASET}/real-only/depth/model-rc${PT_REAL_DATA_CHUNK}.net
ENC_FT_NORMAL=$PROJ_DIR/weights/encoders-special/${DATASET}/real-only/normal/model-rc${PT_REAL_DATA_CHUNK}.net

SP_SESSION=''
if [ "$PT_REAL_DATA_DOM" == "in_place" ];
  then
    SP_SESSION='load-real-only'-ip-ft${PT_REAL_DATA_CHUNK}
  else
    SP_SESSION='load-real-only'-oop-ft${PT_REAL_DATA_CHUNK}
fi
