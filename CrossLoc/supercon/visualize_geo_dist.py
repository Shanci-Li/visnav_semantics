...
from supercon.util_supercon import load_geo_dist, get_supercon_dataloader
...
def config_dataloader(scene, top_n, real_chunk=1.0):
    ...
    trainset_supercon = CamLocDatasetSupercon(root_dir_sim=os.path.join(PROJECT_DIR, "../datasets", scene, "train_sim_aug"),
                                              ...
                                              augment=False, grayscale=False, raw_image=True, real_data_chunk=real_chunk,
                                              supercon=True,
