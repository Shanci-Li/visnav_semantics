import argparse
import os
from Cycada.cyclegan.util import util
import torch
...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='/DataDisk/visnav_semantics/baseline/datasets/comballaz',
                                 help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=286, help='scale images to this size')
        self.parser.add_argument('--fineSize', default=(240,360), help='then crop to this size')
        ...
        self.parser.add_argument('--name', type=str, default='comballaz_pairwise', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--model', type=str, default='cycle_gan_semantic',
                                 help='chooses which model to use. cycle_gan, pix2pix, test')
        self.parser.add_argument('--which_direction', type=str, default='AtoB', help='AtoB or BtoA')
        self.parser.add_argument('--nThreads', default=16, type=int, help='# threads for loading data')
        self.parser.add_argument('--checkpoints_dir', type=str, default='/DataDisk/cycada_checpoints', help='models are saved here')
        ...
        self.parser.add_argument('--display_winsize', default=(240, 360), help='display window size')
        ...
        self.parser.add_argument('--no_flip', default=True, help='if specified, do not flip the images for data augmentation')
