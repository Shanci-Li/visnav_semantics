...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--phase', default=['train_drone_sim', 'train_drone_real'], help='train, val, test, etc')
        ...
        self.parser.add_argument('--fs_model', type=str, default='/media/shanci/Samsung_T5/checkpoint/EPFL/Deeplabv3plus_res50/CrossEntropyLoss2d/augmentation/sim_data_inplace/best_Miou_model.pth',
