...
src='test_drone_sim'
tgt='test_drone_real'
datadir='/home/shanci/Desktop/VNAV_sp/visnav_semantics/baseline/datasets/EPFL'


resdir="/media/shanci/DataDisk/cyclegta/results/${src}_to_${tgt}/adda_sgd/${weight_share}_nolsgan_${discrim}"
...
base_model="/media/shanci/DataDisk/cyclegta/${model}-${src}-iter${baseiter}.pth"
